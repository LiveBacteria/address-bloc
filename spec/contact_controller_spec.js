...
describe("ContactController", () => {
    ...
    describe("#addContact", () => {
        it("should add a single contact into the book", (done) => {
            this.book.addContact("Alice", "001-101-1010", "alicemorrison@gmail.com").then((contact) => {
                expect(contact.name).toBe("Alice");
                expect(contact.phone).toBe("001-101-1010");
                expect(contact.email).toBe("alicemorrison@gmail.com")
                done();
            }).catch((err) => {
                done();
            });
    ...
    describe("#getContacts", () => {
        ...
        it("should return an array of contacts when contacts are available", (done) => {
            this.book.addContact("Alice", "101-010-1010", "alicemorrison@gmail.com").then(() => {
    ...
    describe("#iterativeSearch()", () => {
        ...
        it("should return contact when found", (done) => {
